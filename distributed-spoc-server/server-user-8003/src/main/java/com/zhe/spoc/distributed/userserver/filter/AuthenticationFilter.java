package com.zhe.spoc.distributed.userserver.filter;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.zhe.common.entity.UserEntity;
import com.zhe.common.utils.EncryptUtil;
...
public class AuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        if (StringUtils.isNotBlank(token)){
            ...
            String[] authorities = (String[]) tempJsonArray.toArray(new String[tempJsonArray.size()]);
